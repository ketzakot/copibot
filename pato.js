...
turbo.on('chat-update', async (mek) => {
	try {
		...
		const ownerNumber = ['56998542222@s.whatsapp.net'] //turbo owner
//SETTING WeA
...
//
		...
		mess = {
			wait: 'Espera trabajo en eso va?',
			success: 'Comando con  éxito',
			wrongFormat: 'puedes escribir bien el pt formato?',
			error: {
				stick: 'lo siento te falle no pude convertir en sticker ',
				Iv: 'pon bien el pinche link '
			},
			only: {
				group: 'Nmms este comando solo puede ser usado en grupos',
				admin: 'Solo los admin facheritos pueden usar este comando',
				Badmin: 'Ptmd sin admin no puedo hacer nada :v'
			}
		}
		const isUrl = (url) => {
...
//
    var menu = `  
✔︎ 
𝙺𝚎𝚝𝚣𝚊𝚔𝚘𝚝_𝚢_𝙼𝚘𝚗𝚝𝚜𝚎𝚛𝚛𝚊𝚝
┏━━━━━━━━━━━━━┓
∝╬→Prefix 『 # 』
∝╬→ HOLA ${pushname} bienvenid@ este es mi menu😁
☞︎︎︎𝚌𝚛𝚎𝚍𝚒𝚝𝚘𝚜☜︎︎︎
∝╬→𝚖𝚛 𝚙𝚊𝚝𝚘𓅰
∝╬→𝚃𝚞𝚛𝚋𝚘⚠︎
∝╬→𝚔𝚎𝚝𝚣𝚊𝚔𝚘𝚝✍︎
━━━━━━━━━━━━━
¡Hola!『Soy el 𝙺𝚒𝚕𝚕𝚎𝚛𝙱𝚘𝚝』
━━━━━━━━━━━━━
╭───────╯•╰───────╮
『 MENU 』
𝐈𝐧𝐟𝐨
...
₮ɄɌɃØ 𝐈𝐧𝐟𝐨 𝐝𝐞𝐥 𝐛𝐨𝐭
⚠︎➪ 𝐇𝐢𝐭𝐬 𝐝𝐞 𝐡𝐨𝐲 : ${hit_today.length}*
⚠︎➪ 𝐂𝐞𝐥𝐮𝐥𝐚𝐫 : ${device_manufacturer}
⚠︎➪ 𝐌𝐨𝐝𝐞𝐥𝐨 : ${device_model}
⚠︎➪ 𝐑𝐀𝐌 : ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB
⚠︎➪ 𝐀𝐧𝐝𝐫𝐨𝐢𝐝 : ${os_version}
⚠︎➪ 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 𝐝𝐞 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 : ${wa_version}
⚠︎➪ 𝐂𝐡𝐚𝐭𝐬 : ${giid.length}
⚠︎➪ 𝐆𝐫𝐮𝐩𝐨𝐬 : ${totalchat.length - giid.length}
⚠︎➪ 𝐓𝐨𝐭𝐚𝐥 𝐝𝐞 𝐜𝐡𝐚𝐭𝐬 :${totalchat.length}
⚠︎➪ 𝐕𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 : ${sepid.toFixed(4)} 𝐬𝐞𝐠𝐮𝐧𝐝𝐨𝐬
⚠︎➪ 𝐓𝐢𝐞𝐦𝐩𝐨 𝐚𝐜𝐭𝐢𝐯𝐨 : ${runtem}
⚠︎➪ 𝐏𝐫𝐞𝐟𝐢𝐱 : 「 ${prefix} 」
╔══••ೋೋ••══╗
   ☬✪𝐂𝐫𝐞𝐚𝐝𝐨𝐫𝐞𝐬✪☬
☞-TURBO☬NTR➣✪.li
